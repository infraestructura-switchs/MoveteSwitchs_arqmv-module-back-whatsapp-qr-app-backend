...
public class AdminRestaurantTableService implements AdminRestaurantTableInterface {
    ...
    public RestaurantTable changeStatusOcuped(AdminChangeStatusTableDTO adminChangeStatusTableDTO) {
        ...
        String title = "Mesa " + adminChangeStatusTableDTO.getTableNumber() + " - Estado actualizado";
        String body = "La mesa " + adminChangeStatusTableDTO.getTableNumber() + " ha cambiado de estado. Revisa la lista de mesas.";
