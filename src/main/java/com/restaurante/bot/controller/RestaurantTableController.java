...
public class RestaurantTableController {
    ...
    private final RestaurantTableUseCase restaurantTableUseCase;
    ...
    public List<RestaurantTable> ListarMesas() {
        ...
        return restaurantTableUseCase.ListarMesas();
    }
    ...
    public ResponseEntity<RestaurantTable> addTable(@RequestParam Long tableNumber) {
        ...
        return new ResponseEntity<>(restaurantTableUseCase.addTable(tableNumber), HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<GenericResponse> deleteTable(@PathVariable("tableId") Long tableId) {
        ...
        return new ResponseEntity<>(restaurantTableUseCase.deleteTable(tableId), HttpStatus.OK);
    }
    ...
    public ResponseEntity<RestaurantTable> changeStatusOcuped(@RequestBody ChangeStatusTableDTO changeStatusTableDTO) {
        log.info("Changing table {} to OCCUPIED status", changeStatusTableDTO.getTableNumber());
        return new ResponseEntity<>(
            restaurantTableUseCase.changeStatusOcuped(changeStatusTableDTO),
            HttpStatus.OK);
    }
    ...
    public ResponseEntity<RestaurantTable> changeStatusFree(@RequestParam Long tableNumber) {
        ...
        return new ResponseEntity<>(restaurantTableUseCase.changeStatusFree(tableNumber), HttpStatus.OK);
    }
    ...
    public ResponseEntity<RestaurantTable> changeStatusRequestingService(@RequestBody NumberDTO tableNumber) {
        ...
        return new ResponseEntity<>(
            restaurantTableUseCase.changeStatusRequestingService(tableNumber),
            HttpStatus.OK);
    }
    ...
    public ResponseEntity<RestaurantTable> changeStatusReserved(@RequestParam Long tableNumber) {
        ...
        return new ResponseEntity<>(restaurantTableUseCase.changeStatusReserved(tableNumber), HttpStatus.OK);
    }
    ...
    public ResponseEntity<RestaurantTable> changeStatusPay(@RequestBody NumberDTO tableNumber) {
        ...
        return new ResponseEntity<>(restaurantTableUseCase.changeStatusPay(tableNumber), HttpStatus.OK);
    }
}
